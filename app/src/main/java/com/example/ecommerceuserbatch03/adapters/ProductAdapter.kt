...
import com.example.ecommerceuserbatch03.databinding.ProductItemRowBinding
...
class ProductAdapter(val cartBtnAction: (String, CartItem) -> Unit) : ListAdapter<Product, ProductAdapter.ProductViewHolder>(
    ProductDiffUtil()
){
