...
import com.example.ecommerceuserbatch03.databinding.CartItemLayoutBinding
import com.example.ecommerceuserbatch03.models.CartItem

class CartItemAdapter(val cartBtnAction: (CartItem) -> Unit) : ListAdapter<CartItem, CartItemAdapter.CartItemViewHolder>(
    CartItemDiffUtil()
){
    ...
    override fun onBindViewHolder(holder: CartItemViewHolder, position: Int) {
        ...
        Log.e("cartItem: ", "${cartItem.quantity}", )
